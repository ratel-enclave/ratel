...
void ocall_print_syscallno_numargs(long arg1,long arg2)
{
    printf("arg1: %lx arg2: %lx\n", arg1, arg2);
}
...
long ocall_syscall_2_TioN(long sysno, void *Tio, int N)
{
    long ret = 0;
    bool b = false;
...
long ocall_syscall_3_PiNN(long sysno, void *Pi, long N1, long N2)
{
    long ret = 0;
    bool b = false;
...
long ocall_syscall_3_NNPo(long sysno,long N1,long N2,void *Po,int len)
{
    long ret = 0;
    bool b = false;
...
long ocall_syscall_3_NPolN(long sysno, long N1, void *T, long l1, long N2)
{
    long ret = 0;
    bool b = false;
...
long ocall_syscall_3_NTiN(long sysno, long N1, void *Ti, long dumb, long N2, void *pi, long len)
{
    long ret = 0;
    bool b = false;
...
long ocall_syscall_3_SSS(long sysno, const char *S1, char** S2, char** S3)
{
    long ret = 0;
    bool b = false;

    if (sysno == SYS_execve) {
        ret = syscall(sysno, S1, S2, S3);
        b = true;
    }
...
long ocall_syscall_4_NTiToN(long sysno, long N1, void *Ti, long l1, void *To, long l2, long N2)
{
    long ret = 0;
    bool b = false;
...
long ocall_syscall_6_NPoNNTiPo(long sysno, long N1, void* Po1, long N2, long N3, void* Ti, long l1, void* Po2, int l2)
{
    long ret = 0;
    bool b = false;

    if (sysno == SYS_recvfrom) {
        ret = syscall(sysno, N1, Po1, N2, N3, Ti, Po2);
        b = true;
    }
...
long ocall_syscall_6_PiNNTioPioN(long sysno, int* Pi, long P1, long N1, long N2, void *Tio, long l, int *Pio, long N3)
{
    long ret = 0;
    bool b = false;

    if (sysno == SYS_futex) {
		assert(false && "unsupported futex syscall");
        ret = syscall(sysno, Pi, N1, N2, Tio, Pio, N3);
        b = true;
    }
...
long ocall_syscall_6_NPoNNToN(long sysno,long N1,void* Po,long N2,long N3,void* To, int N4)
{
    long ret = 0;
    bool b = false;

    if (sysno == SYS_sendto) {
        ret = syscall(sysno, N1, Po, N2, N3, To, N4);
        b = true;
    }

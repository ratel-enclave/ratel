...
long ocall_syscall_3_NNVio(long sysno,long N1,long N2,void *T,long len)
{
    long ret = 0;
    bool b = false;
...
long ocall_syscall_6_NVoNNToPo(long sysno,long N1,void* V1,long N2,long N3,void* T, int* N4)
{

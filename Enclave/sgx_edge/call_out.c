...
static inline void cleanup_exited_thread_inside_trace()
{
    ...
    int hcn = 0;
    int tid = sgx_syscall_0(SYS_gettid);
    bool found = false;
...
/*--------------------------------------General syscalls-------------------------------------------*/
void ocall_print_c(const char *cp)
{
    ocall_print_str(cp);
}
...
long sgx_syscall_1(long sysno, long _rdi)
{
    ...
    switch(sysno) {
        ...
        case SYS_set_tid_address:
           // unimplemented_syscall(sysno);
        ocall_syscall_1_To(&ret, sysno, (long*)_rdi, sizeof(int*));
            break;
...
long sgx_syscall_2(long sysno, long _rdi, long _rsi)
{
    ...
    switch (sysno) {
        ...
        case SYS_set_robust_list:
            ocall_syscall_2_TioN(&ret, sysno, (void*)_rdi, _rsi);
            break;
...
long sgx_syscall_3(long sysno, long _rdi, long _rsi, long _rdx)
{
    ...
    case SYS_socket:
        ...
        case SYS_writev:
            {
                ...
                ocall_syscall_3_NTiN(&ret, sysno, _rdi, (void*)_rsi, len_iovec, _rdx, (void*)iovp, size + 1);
                break;
            }
        ...
        case SYS_mprotect:
            ...
            break;
        case SYS_bind:
            ocall_syscall_3_NPolN(&ret, sysno, _rdi, (void*)_rsi, len_sockaddr, _rdx);
            break;
        case SYS_connect:
            ocall_syscall_3_NPoN(&ret, sysno, _rdi, (void*)_rsi, _rdx);
            break;
        ...
        case SYS_ioctl:
            {
                if (FIONREAD == _rsi)
                    ocall_syscall_3_NNPo(&ret, sysno, _rdi, _rsi, (void*)_rdx, len_fionread);
                else
                    ocall_syscall_3_NNPo(&ret, sysno, _rdi, _rsi, (void*)_rdx, len_ioctl);
                break;
            }
...
long sgx_syscall_6(long sysno, volatile long _rdi, long _rsi, long _rdx, volatile long _r10, volatile long _r8, long _r9)
{
    long ret = -1;
    byte* addr;
    ...
    switch (sysno) {
        ...
        case SYS_recvfrom:
            {
                ocall_syscall_6_NPoNNTiPo(&ret, sysno, _rdi, (void*)_rsi, _rdx, _r10, (void*)_r8, len_sockaddr, (void*)_r9, len_socklen_t); 
                break;
            }
        ...
        case SYS_futex:
            {
                ...
                ocall_syscall_6_PiNNTioPioN(&ret, sysno, (int*)_rdi, _rdi, _rsi, _rdx, (void*)_r10, len_timespec, (int*) _r8, _r9);
                break;
            }
        case SYS_sendto:
            ocall_syscall_6_NPoNNToN(&ret, sysno, _rdi, (void*)_rsi, _rdx, _r10, (void*)_r8, _r9);
            break;
...
long sgx_syscall(long sysno, long _rdi, long _rsi, long _rdx, long _r10, long _r8, long _r9)
{
    ...
    switch (sysno) {
        ...
        case SYS_fork:
			if (SYS_fork == sysno)
			{	
				ASSERT(false && "unsupported fork syscall");
				return -1;
			}
        ...
        long arg5, long arg6)
{
   ...
   // ocall_print_syscallno_numargs(sysnum,num_args);
    switch(num_args) {
        case 0:
    //ocall_print_syscallname(sysnum);
    //ocall_print_str(" args 0\n");
            return sgx_syscall_0(sysnum);

        case 1:
    //ocall_print_syscallname(sysnum);
    //ocall_print_str(" args 1\n");
            return sgx_syscall_1(sysnum, arg1);

        case 2:
    //ocall_print_syscallname(sysnum);
    //ocall_print_str(" args 2\n");
            return sgx_syscall_2(sysnum, arg1, arg2);

        case 3:
    //ocall_print_syscallname(sysnum);
    //ocall_print_str(" args 3\n");
            return sgx_syscall_3(sysnum, arg1, arg2, arg3);

        case 4:
    //ocall_print_syscallname(sysnum);
    //ocall_print_str(" args 4\n");
            return sgx_syscall_4(sysnum, arg1, arg2, arg3, arg4);

        case 5:
    //ocall_print_syscallname(sysnum);
    //ocall_print_str(" args 5\n");
            // arg5 = *((long*)_rbp + 2);
        ...
        default:
            ...
            ASSERT(false && "too many arguments! crash me!");
            return -1;
            break;
    }
}

...
# 1 "./core/unix/include/syscall.h" 1
# 22 "./core/unix/include/syscall.h"
# 1 "./core/unix/include/syscall_linux_x86.h" 1
# 23 "./core/unix/include/syscall.h" 2
# 75 "core/arch/x86/x86.asm" 2
# 115 "core/arch/x86/x86.asm"
# 1 "core/arch/x86/x86_asm_defines.asm" 1
# 116 "core/arch/x86/x86.asm" 2
# 151 "core/arch/x86/x86.asm"
...
# 213 "core/arch/x86/x86.asm"

# 245 "core/arch/x86/x86.asm"
        .align 0 
.global get_pic_xdi 
.hidden get_pic_xdi 
...
# 685 "core/arch/x86/x86.asm"
 ...
 call dynamo_thread_stack_free_and_exit 
        ...
        pop rdi
        pop rsi
# 736 "core/arch/x86/x86.asm"
        mov dword ptr [rip + initstack_mutex], 0
# 745 "core/arch/x86/x86.asm"
...
# 1162 "core/arch/x86/x86.asm"
        .align 0 
.global original_dynamorio_start 
.type original_dynamorio_start, %function
original_dynamorio_start:
...
# 1191 "core/arch/x86/x86.asm"
 ...
 call privload_early_inject 
        ...
        .align 0 
.global sgxdbi_to_dynamorio_stub 
.type sgxdbi_to_dynamorio_stub, %function
sgxdbi_to_dynamorio_stub:
        push rbp
        mov qword ptr [rip + SGXDBI_INIT_STACK], rsp
        mov rsp, rdi
        jmp original_dynamorio_start
        ...
        .align 0 
.global dynamorio_to_sgxdbi_stub 
.type dynamorio_to_sgxdbi_stub, %function
dynamorio_to_sgxdbi_stub:
        mov rsp, qword ptr [rip + SGXDBI_INIT_STACK]
        pop rbp
        mov rax, rdi
        ret
       
# 1227 "core/arch/x86/x86.asm"
        .align 0 
...
dynamorio_sys_exit:
# 1317 "core/arch/x86/x86.asm"
        mov edi, 0
        mov eax, 60


 call sgx_instr_syscall
# 1331 "core/arch/x86/x86.asm"
...
dynamorio_sys_exit_group:
        ...
        .align 0 
.global dynamorio_sys_exit_group_org 
.hidden dynamorio_sys_exit_group_org 
.type dynamorio_sys_exit_group_org, %function
dynamorio_sys_exit_group_org:
        ...
        mov r10, rcx
        syscall
# 1450 "core/arch/x86/x86.asm"
        jmp unexpected_return
       
# 1478 "core/arch/x86/x86.asm"
        .align 0 
.global master_signal_handler_org 
.hidden master_signal_handler_org 
.type master_signal_handler_org, %function
master_signal_handler_org:
...
# 1504 "core/arch/x86/x86.asm"
       
# 1600 "core/arch/x86/x86.asm"
        .align 0 
...
cpuid_supported:
        ...
        .align 0 
.global org_our_cpuid 
.hidden org_our_cpuid 
.type org_our_cpuid, %function
org_our_cpuid:
        mov rax, rdi
        mov rdx, rsi
        mov rcx, rdx
...
_dynamorio_runtime_resolve:
 ...
 call dynamorio_dl_fixup 
        ...
        add rsp, 16
        jmp r11
# 2472 "core/arch/x86/x86.asm"
       
# 2627 "core/arch/x86/x86.asm"

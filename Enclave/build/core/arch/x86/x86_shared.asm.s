...
# 61 "core/arch/x86/x86_shared.asm"
        .align 0 
...
dynamorio_syscall:
        ...
        .align 0 
.global dynamorio_syscall_org 
.hidden dynamorio_syscall_org 
.type dynamorio_syscall_org, %function
dynamorio_syscall_org:
...
syscall_ready:
        mov r10, rcx
        syscall
# 190 "core/arch/x86/x86_shared.asm"
        pop rbx
# 199 "core/arch/x86/x86_shared.asm"
        ret
       
# 376 "core/arch/x86/x86_shared.asm"
        .align 0 
...
# 475 "core/arch/x86/x86_shared.asm"
        .align 0 
.global dynamo_memcpy 
.hidden dynamo_memcpy 
.type dynamo_memcpy, %function
dynamo_memcpy:
...
dynamo_memcpy_post: 
 rep movsb
        ...
        .align 0 
.global dynamo_memset 
.hidden dynamo_memset 
.type dynamo_memset, %function
dynamo_memset:
...
# 521 "core/arch/x86/x86_shared.asm"
.global __memcpy_chk
.hidden __memcpy_chk
...
# 789 "core/arch/x86/x86_shared.asm"

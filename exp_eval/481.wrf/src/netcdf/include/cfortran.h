...
#endif
#if   defined(VISUAL_CPLUSPLUS) && !defined(SPEC_CPU_WINDOWS_ICL)
...
/* If your compiler barfs on ' #error', replace # with the trigraph for #     */
 #error "cfortran.h:  Can't find your environment among:\
	...
	- Intel Fortran with Intel C++ or Visual C++                         \
...
#if defined(f2cFortran) || defined(NAGf90Fortran) || defined(DECFortran) || defined(mipsFortran) || defined(apolloFortran) || defined(sunFortran) || defined(CONVEXFortran) || defined(SXFortran) || defined(extname) || defined(PATHSCALE_COMPILER) || defined(SPEC_CPU_LINUX64_IPF) || defined(SPEC_CPU_CASE_FLAG)
#define CFC_(UN,LN)            _(LN,_)      /* Lowercase FORTRAN symbols.     */
#define orig_fcallsc(UN,LN)    CFC_(UN,LN)
#else 
#if defined(CRAYFortran) || defined(PowerStationFortran) || defined(AbsoftProFortran)  || defined(SPEC_CPU_WINDOWS_ICL)
...
#if defined(NAGf90Fortran) || defined(f2cFortran) || defined(mipsFortran) || defined(PowerStationFortran) || defined(hpuxFortran800) || defined(AbsoftUNIXFortran) || defined(AbsoftProFortran) || defined(SXFortran) || defined(PATHSCALE_COMPILER) || defined(SPEC_CPU_LINUX64_IPF) || defined(SPEC_CPU_LOGICAL_STRICT)

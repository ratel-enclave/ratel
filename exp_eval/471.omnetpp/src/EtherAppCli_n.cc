...
// date:	Tue May 18 19:06:53 2004
//
// Input file:	EtherAppCli.ned
// Output file:	EtherAppCli_n.cc
//-----------------------------------------
...
//--------------------------------------------
// Following code generated from: EtherAppCli.ned
//--------------------------------------------

ModuleInterface( EtherAppCli )
	Machine( default )
	Parameter( destStation, ParType_String )
	Parameter( destAddress, ParType_String )
	Parameter( waitTime, ParType_Numeric )
	Parameter( reqLength, ParType_Numeric )
	Parameter( respLength, ParType_Numeric )
	Parameter( writeScalars, ParType_Bool )
	Gate( in, GateDir_Input )
	Gate( out, GateDir_Output )
EndInterface

Register_ModuleInterface( EtherAppCli )

// class EtherAppCli : public cSimpleModule
// {
//     Module_Class_Members(EtherAppCli,cSimpleModule,8192)

...
{
    // note: this method may be called durig autoconfig period too, but we really
...
void EtherMAC::handleEndTxPeriod()
{
    ...
    // this is not entirely correct, there must be IFG between burst frames too
...
#else
    cMessage *jam = new cMessage(NULL, JAM_SIGNAL);
#endif

...
//--------------------------------------------
// Following code generated from: EtherMAC.ned
//--------------------------------------------

ModuleInterface( EtherMAC )
	Machine( default )
	Parameter( promiscuous, ParType_Bool )
	Parameter( address, ParType_String )
	Parameter( txrate, ParType_Numeric )
	Parameter( duplexEnabled, ParType_Bool )
	Parameter( maxQueueSize, ParType_Numeric )
	Parameter( writeScalars, ParType_Bool )
	Gate( physicalIn, GateDir_Input )
	Gate( physicalOut, GateDir_Output )
	Gate( upperLayerIn, GateDir_Input )
	Gate( upperLayerOut, GateDir_Output )
EndInterface

Register_ModuleInterface( EtherMAC )

// class EtherMAC : public cSimpleModule
// {
//     Module_Class_Members(EtherMAC,cSimpleModule,8192)

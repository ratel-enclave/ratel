...
//
// Input file:	EtherBus.ned
// Output file:	EtherBus_n.cc
//-----------------------------------------
...
//--------------------------------------------
// Following code generated from: EtherBus.ned
//--------------------------------------------

ModuleInterface( EtherBus )
	Machine( default )
	Parameter( positions, ParType_String )
	Parameter( propagationSpeed, ParType_Numeric )
	Parameter( writeScalars, ParType_Bool )
	Gate( in[], GateDir_Input )
	Gate( out[], GateDir_Output )
EndInterface

Register_ModuleInterface( EtherBus )

// class EtherBus : public cSimpleModule
// {
//     Module_Class_Members(EtherBus,cSimpleModule,8192)

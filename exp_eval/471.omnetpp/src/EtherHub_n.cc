...
//
// Input file:	EtherHub.ned
// Output file:	EtherHub_n.cc
//-----------------------------------------
...
//--------------------------------------------
// Following code generated from: EtherHub.ned
//--------------------------------------------

ModuleInterface( EtherHub )
	Machine( default )
...
Register_ModuleInterface( EtherHub )

// class EtherHub : public cSimpleModule
// {
//     Module_Class_Members(EtherHub,cSimpleModule,8192)

...
#if defined(SPEC_CPU_P64)
#if defined(SPEC_CPU_WIN64)
inline cEnvir& operator<< (cEnvir& ev, unsigned __int64 i64)
  {ev.printf("%I64u", i64); return ev;}
#else
inline cEnvir& operator<< (cEnvir& ev, uint64_t i64)
  {ev.printf("%I64u", i64); return ev;}
#endif /* SPEC_CPU_WIN64 */
#endif /* SPEC_CPU_P64 */

...
// date:	Tue May 18 19:07:08 2004
//
// Input file:	MACRelayUnitPP.ned
// Output file:	MACRelayUnitPP_n.cc
//-----------------------------------------
...
//--------------------------------------------
// Following code generated from: MACRelayUnitPP.ned
//--------------------------------------------

ModuleInterface( MACRelayUnitPP )
	Machine( default )
	Parameter( addressTableFile, ParType_String )
	Parameter( addressTableSize, ParType_Numeric )
	Parameter( agingTime, ParType_Numeric )
	Parameter( processingTime, ParType_Numeric )
	Parameter( bufferSize, ParType_Numeric )
	Parameter( highWatermark, ParType_Numeric )
	Parameter( pauseUnits, ParType_Numeric )
	Parameter( writeScalars, ParType_Bool )
	Gate( lowerLayerIn[], GateDir_Input )
	Gate( lowerLayerOut[], GateDir_Output )
EndInterface

Register_ModuleInterface( MACRelayUnitPP )

// class MACRelayUnitPP : public cSimpleModule
// {
//     Module_Class_Members(MACRelayUnitPP,cSimpleModule,8192)

...
//
// SPEC_CPU_STDLIB_USING_ERROR:
// The portability flag SPEC_CPU_STDLIB_USING_ERROR is added
// for compilers that cannot handle the following code:
//    #include <cmath>
//    using std::acos;
//    ... = new cFunctionType(..., acos, ...);
//  These compilers for some reason thinks acos is an <unknown type>.
//  Using SPEC_CPU_STDLIB_USING_ERROR will give the following
//  code instead:
//    #include <cmath>
//    ... = new cFunctionType(..., std::acos, ...);
//  which seems to work. 
//

//=== Functions  (register them for findFunction())
#if defined(SPEC_CPU) && !defined(SPEC_CPU_STDLIB_USING_ERROR)
using std::acos;
using std::asin;
using std::atan;
using std::atan2;
...
Define_Math_Function( acos,  1 )
Define_Math_Function( asin,  1 )
Define_Math_Function( atan,  1 )
Define_Math_Function( atan2, 2 )

Define_Math_Function( sin,  1 )
Define_Math_Function( cos,  1 )
Define_Math_Function( tan,  1 )

Define_Math_Function( ceil,  1 )
Define_Math_Function( floor, 1 )

Define_Math_Function( exp,  1 )
Define_Math_Function( pow,  2 )
Define_Math_Function( sqrt, 1 )

Define_Math_Function( fabs, 1 )
Define_Math_Function( fmod, 2 )

Define_Math_Function( log,   1 )
Define_Math_Function( log10, 1 )

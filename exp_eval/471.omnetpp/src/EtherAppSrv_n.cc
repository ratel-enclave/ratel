...
// date:	Tue May 18 19:06:54 2004
//
// Input file:	EtherAppSrv.ned
// Output file:	EtherAppSrv_n.cc
//-----------------------------------------
...
//--------------------------------------------
// Following code generated from: EtherAppSrv.ned
//--------------------------------------------

ModuleInterface( EtherAppSrv )
	Machine( default )
...
Register_ModuleInterface( EtherAppSrv )

// class EtherAppSrv : public cSimpleModule
// {
//     Module_Class_Members(EtherAppSrv,cSimpleModule,8192)
